...
function showHistoryData() {
    let lastBmi = bmiHistoryData[bmiHistoryData.length - 1].bmi;
    let lastBmiState = bmiHistoryData[bmiHistoryData.length - 1].bmiState;
    console.log(`您總共計算${bmiHistoryData.length}次 BMI 紀錄，最後一次 BMI 指數為${lastBmi} 26.83，體重${bmiStatesData[lastBmiState].state}！健康指數為${bmiStatesData[lastBmiState].color}！`);
}
