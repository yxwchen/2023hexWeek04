...
function showHistoryData() {
    ...
    let lastState = bmiHistoryData[dataLength - 1].bmiState;

    console.log(dataLength);
    console.log(`您總共計算 3 次 BMI 紀錄，最後一次 BMI 指數為 ${lastBmi}，體重${bmiStatesData[lastState].state}！健康指數為${bmiStatesData[lastState].color}！`);
}
